...
const HELP_TEXTS = {
  ...
  autostartHelp: `
    ...
    <div class="note">
      <strong>Примечание:</strong> Браузер запускается с обычным профилем пользователя, просто с добавленным флагом <code>--proxy-server</code>. Все ваши закладки, пароли и расширения остаются доступными.
    </div>
