...
const TRANSLATIONS = {
  ru: {
    ...
    apiPort: 'Порт API:',
    setupFlowLink: 'Настройка FlowLink Proxy',
    backend: 'Бэкенд',
    browser: 'Браузер',
    ...
    helpConsent: 'Используя FlowLink Proxy, вы соглашаетесь с условиями',
    helpEula: 'Лицензионное соглашение (EULA)',
    helpPrivacy: 'Политика конфиденциальности',
  ...
  en: {
    ...
    apiPort: 'API port:',
    setupFlowLink: 'FlowLink Proxy Setup',
    backend: 'Backend',
    browser: 'Browser',
    ...
    helpConsent: 'By using FlowLink Proxy, you agree to the',
    helpEula: 'License Agreement (EULA)',
  ...
  sr: {
    ...
    connection: 'Veza',
    apiPort: 'API port:',
    setupFlowLink: 'Podešavanje FlowLink Proxy',
    backend: 'Backend',
    browser: 'Pregledač',
    ...
    helpConsent: 'Korišćenjem FlowLink Proxy, slažete se sa',
    helpEula: 'Licencni ugovor (EULA)',
    helpPrivacy: 'Politika privatnosti',
